...
CodegenConstants.LOCAL_VARIABLE_PREFIX_DESC = "prefix for generated code members and local variables";
CodegenConstants.SERIALIZABLE_MODEL = "serializableModel";
CodegenConstants.SERIALIZABLE_MODEL_DESC = "boolean - toggle \"implements Serializable\" for generated models";
CodegenConstants.SERIALIZE_BIG_DECIMAL_AS_STRING = "bigDecimalAsString";
CodegenConstants.SERIALIZE_BIG_DECIMAL_AS_STRING_DESC = "Treat BigDecimal values as Strings to avoid precision loss.";
...
CodegenConstants.SORT_PARAMS_BY_REQUIRED_FLAG_DESC = "Sort method arguments to place required parameters before optional parameters.";
CodegenConstants.USE_DATETIME_OFFSET = "useDateTimeOffset";
CodegenConstants.USE_DATETIME_OFFSET_DESC = "Use DateTimeOffset to model date-time properties";
CodegenConstants.ENSURE_UNIQUE_PARAMS = "ensureUniqueParams";
CodegenConstants.ENSURE_UNIQUE_PARAMS_DESC = "Whether to ensure parameter names are unique in an operation (rename parameters that are not).";
...
CodegenConstants.PACKAGE_TITLE_DESC = "Specifies an AssemblyTitle for the .NET Framework global assembly attributes stored in the AssemblyInfo file.";
CodegenConstants.PACKAGE_PRODUCTNAME = "packageProductName";
CodegenConstants.PACKAGE_PRODUCTNAME_DESC = "Specifies an AssemblyProduct for the .NET Framework global assembly attributes stored in the AssemblyInfo file.";
CodegenConstants.PACKAGE_DESCRIPTION = "packageDescription";
CodegenConstants.PACKAGE_DESCRIPTION_DESC = "Specifies a AssemblyDescription for the .NET Framework global assembly attributes stored in the AssemblyInfo file.";
CodegenConstants.PACKAGE_COMPANY = "packageCompany";
CodegenConstants.PACKAGE_COMPANY_DESC = "Specifies an AssemblyCompany for the .NET Framework global assembly attributes stored in the AssemblyInfo file.";
CodegenConstants.PACKAGE_COPYRIGHT = "packageCopyright";
CodegenConstants.PACKAGE_COPYRIGHT_DESC = "Specifies an AssemblyCopyright for the .NET Framework global assembly attributes stored in the AssemblyInfo file.";
CodegenConstants.POD_VERSION = "podVersion";
CodegenConstants.OPTIONAL_METHOD_ARGUMENT = "optionalMethodArgument";
CodegenConstants.OPTIONAL_METHOD_ARGUMENT_DESC = "Optional method argument, e.g. void square(int x=10) (.net 4.0+ only).";
...
CodegenConstants.USE_COLLECTION_DESC = "Deserialize array types to Collection<T> instead of List<T>.";
CodegenConstants.RETURN_ICOLLECTION = "returnICollection";
CodegenConstants.RETURN_ICOLLECTION_DESC = "Return ICollection<T> instead of the concrete type.";
...
CodegenConstants.OPTIONAL_PROJECT_GUID_DESC = "The GUID that will be associated with the C# project";
CodegenConstants.MODEL_PROPERTY_NAMING = "modelPropertyNaming";
CodegenConstants.MODEL_PROPERTY_NAMING_DESC = "Naming convention for the property: \'camelCase\', \'PascalCase\', \'snake_case\' and \'original\', which keeps the original name";
...
CodegenConstants.MODEL_NAME_PREFIX_DESC = "Prefix that will be prepended to all model names. Default is the empty string.";
CodegenConstants.MODEL_NAME_SUFFIX = "modelNameSuffix";
CodegenConstants.MODEL_NAME_SUFFIX_DESC = "Suffix that will be appended to all model names. Default is the empty string.";
CodegenConstants.OPTIONAL_EMIT_DEFAULT_VALUES = "optionalEmitDefaultValues";
CodegenConstants.OPTIONAL_EMIT_DEFAULT_VALUES_DESC = "Set DataMember\'s EmitDefaultValue.";
...
CodegenConstants.HTTP_USER_AGENT_DESC = "HTTP user agent, e.g. codegen_csharp_api_client, default to \'Swagger-Codegen/{packageVersion}}/{language}\'";
...
CodegenConstants.EXCLUDE_TESTS_DESC = "Specifies that no tests are to be generated.";
CodegenConstants.GENERATE_API_TESTS = "generateApiTests";
CodegenConstants.GENERATE_API_TESTS_DESC = "Specifies that api tests are to be generated.";
CodegenConstants.GENERATE_MODEL_TESTS = "generateModelTests";
CodegenConstants.GENERATE_MODEL_TESTS_DESC = "Specifies that model tests are to be generated.";
