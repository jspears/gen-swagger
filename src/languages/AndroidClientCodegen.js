...
export default class AndroidClientCodegen extends DefaultCodegen {
    ...
    constructor() {
        ...
        this.__embeddedTemplateDir = this.__templateDir = "android";
        ...
        this.__languageSpecificPrimitives = newHashSet("String", "boolean", "Boolean", "Double", "Integer", "Long", "Float", "byte[]", "Object");
        ...
        this.__supportedLibraries.put("volley", "HTTP client: Volley 1.0.19 (default)");
        this.__supportedLibraries.put("httpclient", "HTTP client: Apache HttpClient 4.3.6. JSON processing: Gson 2.3.1. IMPORTANT: Android client using HttpClient is not actively maintained and will be depecreated in the next major release.");
        let library = new CliOption(CodegenConstants.LIBRARY, "library template (sub-template) to use");
    ...
    processOpts() {
        ...
        if (("volley" === this.getLibrary())) {
            this.addSupportingFilesForVolley();
        }
        else if (("httpclient" === this.getLibrary())) {
