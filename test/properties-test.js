...
describe('properties', function () {
    ...
    it('ObjectProperty', function () {
        const strp = factory(({
            type: 'object',
            properties: {
                "num1": {type: "number", "description": "is a number"},
        ...
        console.log(JSON.stringify(strp, null, 2))
        isClass(strp, 'ObjectProperty');
        isClass(strp.getProperties().get("num1"), 'NumberProperty');
        isClass(strp.getProperties().get("obj1").getProperties().get("prop1"), 'StringProperty');
